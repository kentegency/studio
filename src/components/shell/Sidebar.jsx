...
function SbIcon({ Icon, active, onClick, dot, title }) {
  return (
...
export default function Sidebar({ onUpload, onPublish }) {
  ...
  return (
    <aside className="sidebar">
      ...
      <SbIcon Icon={BellIcon}    active={active==='notifs'}   title="Notifications" dot
        onClick={() => click('notifs')} />
      <SbIcon Icon={SketchIcon}  active={active==='sketch'}   title="Sketch"
        onClick={() => click('sketch',  () => openOverlay('sketch'))} />
      <SbIcon Icon={CompareIcon} active={active==='compare'}  title="Compare"
